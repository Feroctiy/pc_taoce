<template>
  <div class="container main_home max_width main main_width padding margin-bottom shadow" style="margin:15px auto;">
    <div class="find-blue-title margin-bottom">报告查询</div>
        ...
        <el-form-item label="" prop="name">
          <el-input placeholder="请输入内容" v-model="input3" class="input-with-select" style="width:300px">
            <el-select v-model="select" slot="prepend" placeholder="请选择" style="width:120px">
              <el-option label="报告编号" value="1"></el-option>
    ...
    <div>
      <el-table :data="list" border style="width: 100%">
        ...
        <el-table-column prop="reportNo" label="报告编号" align="center"></el-table-column>
        <el-table-column prop="ceUser" label="申请人" align="center"></el-table-column>
        <el-table-column prop="zzsdwmc" label="制造商" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() { 
      this.$fetch("/api/orderreport/list", { bgbh : '报告编号' }).then(response => {
        this.loading = false;
        if (response.code == 0) {
